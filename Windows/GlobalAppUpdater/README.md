...
##  Files Included
- **`RUN-ME.bat`**: The entry point. A batch script that checks for Admin privileges, elevates itself if necessary, and launches the PowerShell script.
...
##  How to Use
1. Download or create both `RUN-ME.bat` and `update-all-apps.ps1`.
